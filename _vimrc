" Largely based on mutewinter's VIM of champions
" and edgecases vim-config projects
...
"call pathogen#infect('C:\ide\vim\vimfiles\bundle')

set rtp+=$VIMRUNTIME/../vimfiles/bundle/vundle/
set rtp+=$VIMRUNTIME/../vimfiles/bundle/


call vundle#rc('C:\ide\vim\vimfiles\bundle')
...
set nobackup
set noswapfile
"set backupdir=C:/ide/vim/.backup
"set directory=C:/ide/vim/.vim-tmp
...
nmap <silent> <leader>v :e C:/ide/vim/_vimrc~<CR>
...
if has('win32') || has('win64')
  let g:syntastic_jsl_conf='C:/ide/vim/vimfiles/config/windows/syntastic/jsl.conf'
